package be.intecbrussel.collectionsEnStreams;
...
public class PersonStreamApp {
 ...
 /*RESULT: Person{name='Liselot', male=false, age=23}
                                    Person{name='Fatiah', male=false, age=75}
                                    TWEE VROUWEN BOVEN 20 JAAR*/